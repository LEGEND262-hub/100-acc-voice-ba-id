...
///////////////////
jano.on("ready", () => {
  var join = jano.channels.get("930540191125479444"); /// id voice
  if (join) join.join();
});
///////////////////
jano2.on("ready", () => {
...
jano.on("ready", () => {
  ...
  let statuses = [`ALLWAYS SHETA MY BRO `];
...
jano.login("NzY1ODI3NzcxMzQzNTY4ODk5.YffsTw.PAYefL529EJ2RGOgYeDIS9jw7Ts");
jano2.login("");
jano3.login("");
jano4.login("");
jano5.login("");
